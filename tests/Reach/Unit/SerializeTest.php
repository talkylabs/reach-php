...
class SerializeTest extends UnitTest {
    ...
    public function testIso8601DateNull(): void {
        ...
        $this->assertEquals(\Reach\Values::NONE, $actual);
    }

    public function testIso8601DateNone(): void {
        $actual = Serialize::iso8601Date(\Reach\Values::NONE);
        $this->assertEquals(\Reach\Values::NONE, $actual);
    }
    ...
    public function testIso8601DateTimeNone(): void {
        $actual = Serialize::iso8601DateTime(\Reach\Values::NONE);
        $this->assertEquals(\Reach\Values::NONE, $actual);
    }
    ...
    public function testIso8601DateTimePassString2(): void {
        // Backwards compatibility, prior to 5.5.0 date parameters were passed as strings.
        // After 5.5.0 parameters can be DateTime objects or strings.
        $actual = Serialize::iso8601DateTime('2017-02-01T17:15:41.001Z');
        $this->assertEquals('2017-02-01T17:15:41.001Z', $actual);
    }
    ...
    public function testJsonObjectSerializesArrays(): void {
        ...
        $actual = Serialize::jsonObject(['reach' => 'rocks']);
        $this->assertEquals('{"reach":"rocks"}', $actual);
    }
