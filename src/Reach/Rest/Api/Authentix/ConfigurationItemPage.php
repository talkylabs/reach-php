...
class ConfigurationItemPage extends Page
    {
    /**
     ...
     * @return ConfigurationItemInstance \Reach\Rest\Api\Authentix\ConfigurationItemInstance
     */
    public function buildInstance(array $payload): ConfigurationItemInstance
    {
        return new ConfigurationItemInstance($this->version, $payload);
    }
