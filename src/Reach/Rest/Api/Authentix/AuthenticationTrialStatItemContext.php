...
class AuthenticationTrialStatItemContext extends InstanceContext
    {
    /**
    ...
    public function __construct(
        ...
        $this->uri = '/authentix/v1/authenticationTrialStats';
    }
    ...
    public function fetch(array $options = []): AuthenticationTrialStatItemInstance
    {
        ...
        return new AuthenticationTrialStatItemInstance(
            $this->version,
            $payload
        );
    }
    ...
    public function __toString(): string
    {
        ...
        return '[Reach.Api.Authentix.AuthenticationTrialStatItemContext ' . \implode(' ', $context) . ']';
    }
}
