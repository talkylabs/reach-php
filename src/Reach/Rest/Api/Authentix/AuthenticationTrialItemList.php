...
class AuthenticationTrialItemList extends ListResource
    {
    /**
     * Construct the AuthenticationTrialItemList
     *
    ...
    public function __construct(
        ...
        $this->uri = '/authentix/v1/authenticationTrials';
    }

    /**
     * Reads AuthenticationTrialItemInstance records from the API as a list.
     ...
     * @return AuthenticationTrialItemInstance[] Array of results
     */
     ...
     * @return AuthenticationTrialItemPage Page of AuthenticationTrialItemInstance
     */
    ...
    ): AuthenticationTrialItemPage
    {
        ...
        return new AuthenticationTrialItemPage($baseUrl, $this->version, $response, $this->solution);
    }
     ...
     * @return AuthenticationTrialItemPage Page of AuthenticationTrialItemInstance
     */
    public function getPage(string $targetUrl): AuthenticationTrialItemPage
    {
    ...
    ): AuthenticationTrialItemContext
    {
        return new AuthenticationTrialItemContext(
            $this->version,
            $trialId
        );
    }
