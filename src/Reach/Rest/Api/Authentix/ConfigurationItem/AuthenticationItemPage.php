...
class AuthenticationItemPage extends Page
    {
    /**
     ...
     * @return AuthenticationItemInstance \Reach\Rest\Api\Authentix\ConfigurationItem\AuthenticationItemInstance
     */
    public function buildInstance(array $payload): AuthenticationItemInstance
    {
        return new AuthenticationItemInstance($this->version, $payload, $this->solution['configurationId']);
    }
