...
class AuthenticationControlItemList extends ListResource
    {
    /**
     * Construct the AuthenticationControlItemList
     *
     ...
     */
    public function check(array $options = []): AuthenticationControlItemInstance
    {
        ...
        $payload = $this->version->check('POST', $this->uri, [], $data);

        return new AuthenticationControlItemInstance(
            $this->version,
            $payload,
