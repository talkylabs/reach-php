...
class AuthenticationControlItemPage extends Page
    {
    /**
     ...
     * @return AuthenticationControlItemInstance \Reach\Rest\Api\Authentix\ConfigurationItem\AuthenticationControlItemInstance
     */
    public function buildInstance(array $payload): AuthenticationControlItemInstance
    {
        return new AuthenticationControlItemInstance($this->version, $payload, $this->solution['configurationId']);
    }
    ...
    {
        return '[Reach.Api.Authentix.AuthenticationControlItemPage]';
    }
}
