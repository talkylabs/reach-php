 ...
 * @property array<string,mixed> $channelInfo
 */
class AuthenticationTrialItemInstance extends InstanceResource
{
    /**
     ...
     * @param string $trialId The identifier of the authentication trial to be fetched.
     */
    public function __construct(Version $version, array $payload, string $trialId = null)
    {
        ...
        $this->properties = [
            ...
            'trialId' => Values::array_get($payload, 'trialId'),
            'trialStatus' => Values::array_get($payload, 'trialStatus'),
            ...
            'channelInfo' => Values::array_get($payload, 'channelInfo'),
        ];

        $this->solution = ['trialId' => $trialId ?: $this->properties['trialId'], ];
    }
     ...
     *
     * @return AuthenticationTrialItemContext Context for this AuthenticationTrialItemInstance
     */
    protected function proxy(): AuthenticationTrialItemContext
    {
        if (!$this->context) {
            $this->context = new AuthenticationTrialItemContext(
                $this->version,
                $this->solution['trialId']
            );
        }
     ...
     */
    public function fetch(): AuthenticationTrialItemInstance
    {
    ...
    public function __toString(): string
    {
        ...
        return '[Reach.Api.Authentix.AuthenticationTrialItemInstance ' . \implode(' ', $context) . ']';
    }
}
