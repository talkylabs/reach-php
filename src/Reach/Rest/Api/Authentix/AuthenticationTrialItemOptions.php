...
abstract class AuthenticationTrialItemOptions
{
     ...
     * @param string $trialStatus Retrieve authentication trials with the specified status.
     * @param string $channel Retrieve authentication trials sent via the specified channel.
     * @param string $configurationId Retrieve authentication trials from the configuration whose ID matches the specified one.
     * @param string $authenticationId Retrieve authentication trials from the authentication whose ID matches the specified one.
     ...
     * @param \DateTime $sentAt Retrieve only authentication trials created at the specified date. Must be in ISO 8601 format.
     * @param \DateTime $sentAfter Retrieve only authentication trials created after the specified datetime. Must be in ISO 8601 format.
     * @param \DateTime $sentBefore Retrieve only authentication trials created before the specified datetime. Must be in ISO 8601 format.
     * @return ReadAuthenticationTrialItemOptions Options builder
     */
    ...
    ): ReadAuthenticationTrialItemOptions
    {
        return new ReadAuthenticationTrialItemOptions(
            $dest,
            $trialStatus,
            $channel,
            $configurationId,
...
class ReadAuthenticationTrialItemOptions extends Options
    {
    /**
     * @param string $dest Retrieve authentication trials sent only to this phone number or email. The phone number must be in the E.164 format.
     * @param string $trialStatus Retrieve authentication trials with the specified status.
    ...
    public function __toString(): string
    {
        ...
        return '[Reach.Api.Authentix.ReadAuthenticationTrialItemOptions ' . $options . ']';
    }
}
